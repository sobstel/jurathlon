    ...
    <div className="container">
      ...
      <main>
        ...
        <section>
          ...
          <p>Dystanse: <strong>6km</strong>, <strong>12km</strong>, <strong>18km</strong>, <strong>24km</strong>.</p>
          <p className="links">
              Listy startowe: <a href="https://sportmaniacs.com/pl/services/inscription/jurathlon-run-2020#registrations" target="_blank">sportmaniacs.com</a><br />
